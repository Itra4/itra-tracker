            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="card text-center">
                ...
                <p className="text-xs text-gray-400">
                  {data.inboundLoadCount} load{data.inboundLoadCount !== 1 ? "s" : ""}
                </p>
              </div>
              <div className="card text-center">
                ...
                <p className="text-xs text-gray-400">
                  {data.outboundShipmentCount} shipment{data.outboundShipmentCount !== 1 ? "s" : ""}
                </p>
              </div>
            </div>

            <div className="card text-center">
              <p className="text-sm text-gray-500 mb-1">Variance (Inbound − Outbound)</p>
              <p
                className={`text-3xl font-bold ${
                  data.variance >= 0 ? "text-gray
cat > src/app/reports/mass-balance/page.tsx << 'EOF'
"use client";
